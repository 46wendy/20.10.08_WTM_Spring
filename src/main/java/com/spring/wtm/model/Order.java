...
public class Order {
	...
	/** 상품 정보(Json) - Beans를 Json으로 변환해서 다른 Beans안에 삽입 */
	...
	// 2) // 멤버변수로 저장되어 있는 특정 Beans의 데이터를 JSON 배열로 변환 후 리턴
	...
	// Beans구조를 본딴 JSON 배열을 파라미터로 받아서 Bean 객체로 변환후 멤버변수에 할당
    // TypeToken은 객체의 데이터타입을 알아서 추적해서 변환해주는 기능을 함
