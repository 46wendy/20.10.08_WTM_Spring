...
<div class="medsearch container">
	...
	<form id="search" name="med_search" method="get" action="${pageContext.request.contextPath}/medicine">
				...
				<div class="slider responsive">
					...
					<div class="select_type">
						<img src="assets/img/pill(1).png"
							style="width: 50px; height: 50px; margin-left: 10px;">
						<p class="colorname type" data-value="정제">정제류</p>
 
					</div>
					<div class="select_type">
						<img src="assets/img/pill(2).png"
							style="width: 50px; height: 50px; margin-left: 10px;">
						<p class="colorname type" data-value="경질캡슐">경질캡슐</p>

					</div>
					<div class="select_type">
						<img src="assets/img/pill(3).png"
							style="width: 50px; height: 50px; margin-left: 10px;">
						<p class="colorname type" data-value="연질캡슐">연질캡슐</p>
				...
				<div class="slider responsive">
					...
					<div class="select_line">
						<img src="assets/img/med_shape(1).png"
							style="width: 50px; height: 50px; margin-left: 10px;">
						<p class="colorname line">없음</p>

					</div>
					<div class="select_line">
						<img src="assets/img/med_shape(2).png"
							style="width: 50px; height: 50px; margin-left: 10px;">
						<p class="colorname line" data-value="-">(-)형</p>
					...
					<div class="select_line">
						<img src="assets/img/med_shape(4).png"
							style="width: 50px; height: 50px; margin-left: 10px;">
						<p class="colorname line" data-value="기타">기타</p>
					...
					<a href="${viewUrl}">
						...
						<div class="info_area">
							...
							<p class="truncated_info">[외형정보]· 성상 :   ${item.chart}· 모양 :  ${item.drugShape} · 색상 : ${item.color1} · 색상 : ${item.color2}
							 · 분할선 : ${item.line1} · 분할선 : ${item.line2} · 저장방법 : ${item.storageMethod} ${item.effectData} ${item.usageData}</p>
						</div>
					</li>
				</ul>
				</c:forEach>
	                ...
	                <c:choose>
	                    ...
	                    <c:when test="${pageData.prevPage > 0}">
	                        ...
	                        <c:url value="/medicine" var="prevPageUrl">
	                            ...
	                            <c:param name="shape" value="${shape}" />
	                            <c:param name="type" value="${type}" />
	                            <c:param name="line" value="${line}" />
	                        </c:url>
...
<!-- =============== slick JS 시작 ================= -->
	...
	$(function() {
		...
		$(".select_type").click(function(e) {
			e.preventDefault(); // 데이터 전송 강제 중단
			var type = $(this).find(".type").attr("data-value");
			console.log(type);
			$("#type").val(type);
		});
		$(".select_line").click(function(e) {
			e.preventDefault(); // 데이터 전송 강제 중단
			var line = $(this).find(".line").attr("data-value");
			console.log(line);
			$("#line").val(line);
		});
